...
import { Settings, User, Heart, LogOut, Loader2 } from "lucide-react";
...
export default function Header() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 bg-white/10 backdrop-blur-md border-b border-white/20 transition-all">
            <div className="px-6 py-8 flex justify-between items-start max-w-5xl mx-auto w-full">
                ...
                <div className="flex gap-3 relative z-50">
                    ...
                    <button
                        ...
                        className="w-12 h-12 flex items-center justify-center bg-white border-2 border-blue-100 rounded-full text-blue-400 hover:border-blue-300 hover:text-blue-600 transition-colors shadow-sm font-bold text-sm"
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="p-3 bg-white border-2 border-rose-100 rounded-full text-rose-400 hover:border-rose-300 hover:text-rose-600 transition-colors shadow-sm relative focus:outline-none focus:ring-2 focus:ring-rose-200"
                        >
                    ...
                    {/* Profile Link */}
                    <Link href="/profile" className="p-3 bg-white border-2 border-purple-100 rounded-full text-purple-400 hover:border-purple-300 hover:text-purple-600 transition-colors shadow-sm cursor-pointer">
